	...
	<div class="panel-heading" id="panel">
		<div class="media">
			...
			<div class="media-body">
				<h3>List of Deceased Officer</h3>
				<span class="pull-right"><a onclick="PrintDeceasedOfficerList()" class="btn btn-success">Print</a></span>
			</div>
		</div>
	</div>
	<div class="panel panel-body" id="">
			<table class="table table-hover table-filter">
				<tbody id="proposal_list">
					...
					$result = $conn->query("SELECT * FROM `tbl_users` where status='Deceased'");
