	...
	<div class="panel-heading" id="panel">
		<div class="media">
			...
			<div class="media-body">
				<div class="col-sm-6">
					<h3>List of Officer Log(s)</h3>
				</div>
				<div class="col-sm-4">
				
				</div>
				<div class="col-sm-2"><a onclick="PrintLogList()" class="btn btn-success btn-block">Print</a>
				</div>
			</div>
		</div>
	</div>
	<div class="panel panel-body" id="">
			<table class="table table-hover table-filter">
				<tbody id="caseGlobal_list">
					...
					$result = $conn->query("SELECT * FROM `tbl_logs` order by transaction_date DESC");
					...
					<tr data-status="pagado" class='alert alert-info'>
						...
						<div class="media">
							<div class="media" id='<?php echo $row['id']; ?>'>
								...
								<p class="summary"><?php echo $row['position']. ' - '.$row['transaction_date']; ?></p>
							</div>
						</div>
						</td>
					</tr><?php
