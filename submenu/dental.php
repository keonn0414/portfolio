	...
	<div class="panel-heading" id="panel">
		<div class="media">
			...
			<div class="media-body">
				<h3>List of Inmate Dental(s)</h3>
				<span class="pull-right"><a onclick="PrintDentalList()" class="btn btn-success">Print</a></span>
			</div>
		</div>
	</div>
	<div class="panel panel-body" id="">
			<table class="table table-hover table-filter">
				<tbody id="proposal_list">
					...
					$result = $conn->query("SELECT * FROM `tbl_dental` order by consultationDate");
