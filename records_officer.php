                            ...
                            <div class="media">
                                <div class="media-left">
                                    ...
                                    <div class="media-body">
                                        <h4 class="media-heading">Hello, Records Officer!</h4>
                                    </div>
                            </div>
                        </div>
                                                            ...
                                                            <tr >
                                                                 <td style="font-size:16px; padding-bottom: 5px;">
                                                                    <span class="glyphicon glyphicon-chevron-right" style="color: #376ec6; font-size: 13px;"></span>
                                                                        <a onclick="showJailBookingReport()" style="cursor:hand;">
                                                                            Jail Booking
                                                                        </a>
                                                                 </td>
                                                            </tr>
...
<script type="text/javascript">
    function showJailBookingReport(){
        $('#bodyPanel').load('InmateRecords/jail_booking_report.php');
        document.getElementById("bodyPanel").style.display = 'initial';
    }
    function showCourtDocuments(){
        $('#bodyPanel').load('RecordsOfficer/court_documents.php');
        document.getElementById("bodyPanel").style.display = 'initial';
    }
    function showManifest(){
        $('#bodyPanel').load('RecordsOfficer/manifest.php');
        document.getElementById("bodyPanel").style.display = 'initial';
    }
    function showCaseStatus(){
        $('#bodyPanel').load('RecordsOfficer/case_status.php');
        document.getElementById("bodyPanel").style.display = 'initial';
    }
